...
//RSVP Function
  function addGuest() {
    ...
    function RSVPchecker() {
      var name_input = document.getElementById('name');
      if(isNumeric(name_input))
      {
        alert("Sorry enter a valid name");
      }
    }
...
<script async defer
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCfbwmVb3CdtksTrrAzqK5G1u3LQ56dtyQ&callback=initMap">
</script>